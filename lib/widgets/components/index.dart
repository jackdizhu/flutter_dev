...
List getWidgets() {
  ...
  result.addAll(Pick.widgetPoints); // CityPicker 报错
  result.addAll(Chip.widgetPoints);
  result.addAll(Panel.widgetPoints);
  result.addAll(Progress.widgetPoints); // 浏览器环境开启F12 EXCEPTION CAUGHT BY RENDERING LIBRARY
  result.addAll(Tab.widgetPoints);
  ...
  result.addAll(Scaffold.widgetPoints); // 点击报错
